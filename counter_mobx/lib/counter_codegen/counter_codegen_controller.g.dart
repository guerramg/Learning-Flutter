...
mixin _$CounterCodeGenController on _CounterCodeGenControllerBase, Store {
  late final _$counterAtom = Atom(
    name: '_CounterCodeGenControllerBase.counter',
    context: context,
  );
  ...
  late final _$_CounterCodeGenControllerBaseActionController = ActionController(
    name: '_CounterCodeGenControllerBase',
    context: context,
  );
